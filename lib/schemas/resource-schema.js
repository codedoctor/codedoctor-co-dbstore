...
(function() {
  var ObjectId, ResourceSchema, errors, mongoose, pluginAccessibleBy, pluginCreatedBy, pluginTagsSimple, pluginTimestamp, _;
  ...
  ResourceSchema.plugin(pluginCreatedBy.createdBy, {
    isRequired: true
  });

  ResourceSchema.plugin(pluginTagsSimple.tagsSimple);

  ResourceSchema.plugin(pluginAccessibleBy.accessibleBy, {
